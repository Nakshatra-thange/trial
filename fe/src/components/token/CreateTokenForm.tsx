      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 rounded-xl bg-[#141414] border border-zinc-700 text-white placeholder-zinc-600 focus:outline-none focus:border-emerald-500 transition-colors duration-200"
            disabled={isLoading}
          />
          {errors.name && (
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 rounded-xl bg-[#141414] border border-zinc-700 text-white placeholder-zinc-600 focus:outline-none focus:border-emerald-500 transition-colors duration-200 uppercase"
            disabled={isLoading}
          />
          {errors.symbol && (
        ...
        <div>
          ...
          <textarea
            ...
            rows={4}
            className="w-full px-4 py-3 rounded-xl bg-[#141414] border border-zinc-700 text-white placeholder-zinc-600 focus:outline-none focus:border-emerald-500 transition-colors duration-200 resize-none"
            disabled={isLoading}
          />
          {errors.description && (
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="w-full py-4 rounded-xl bg-emerald-500 hover:bg-emerald-600 disabled:bg-zinc-800 disabled:text-zinc-600 disabled:cursor-not-allowed text-white font-semibold text-base transition-colors duration-200 flex items-center justify-center gap-2"
        >
          {isLoading ? (
            <>
